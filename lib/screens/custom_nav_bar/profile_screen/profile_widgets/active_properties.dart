...
class ActiveProperties extends StatefulWidget {
  const ActiveProperties({
    Key? key,
  }) : super(key: key);

  @override
  State<ActiveProperties> createState() => _PropertiesListState();
}

class _PropertiesListState extends State<ActiveProperties> {
  String? userType;
